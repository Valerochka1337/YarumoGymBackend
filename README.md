...
- Browser trial: `https://app.valerochkagym.tech/r/{token}`; тот же production job
  атомарно устанавливает проверенный web-архив, Nginx proxy и отдельный Certbot-сертификат.
